...
int main() {
  ...
  if(strcmp(stuff_test_cases[i].method,'cv2.TM_CCOEFF')){
    method_int=cv::TM_CCOEFF;
  }else if(strcmp(stuff_test_cases[i].method,'cv2.TM_CCOEFF_NORMED')){
    method_int=cv::TM_CCOEFF_NORMED;
  }else if(strcmp(stuff_test_cases[i].method,'cv2.TM_CCORR')){
    method_int=cv::TM_CCORR;
  }else if(strcmp(stuff_test_cases[i].method,'cv2.TM_CCORR_NORMED')){
    method_int=cv::TM_CCORR_NORMED;
  }else if(strcmp(stuff_test_cases[i].method,'cv2.TM_SQDIFF')){
    method_int=cv::TM_SQDIFF;
  }else if(strcmp(stuff_test_cases[i].method,'cv2.TM_SQDIFF_NORMED')){
